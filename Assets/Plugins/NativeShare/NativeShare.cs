...
public class NativeShare : MonoBehaviour
{
	...
	public void SharebtnImageGameoverPanel()
	{
	...
	private IEnumerator TakeSSAndShare()
	{
		...
		string filePath = Path.Combine( Application.temporaryCachePath, "TOM.png");
		File.WriteAllBytes( filePath, ss.EncodeToPNG() );

		// To avoid memory leaks
		Destroy( ss );

		new NativeShare().AddFile( filePath ).SetSubject("Spin Warrior").SetText( "https://play.google.com/store/apps/details?id=com.IF.TurboTrail&hl=en" ).Share();
		Share ();
